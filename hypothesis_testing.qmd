...
> One I saw that the economic indicators were missing values, I decided that filling with the median would work best, as to not skew any calculations
...
na_by_economy <- clean_df %>%
  select(Economy, all_of(economic_indicators)) %>%
  #group_by(Economy) %>%
